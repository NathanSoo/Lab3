...
;   r25 will be the ascii value of the ones
...
positive_number:
    ...
    mov r27, r24               ; Get the quotient (hundreds digit) in r27
...
check_tens_digit:
    ...
    rcall divide               ; Call divide subroutine
    mov r27, r24               ; Get the quotient (tens digit) in r27
    cpi r27, 0                ; Check if it's zero
...
display_ones_digit:
    ; Ones place is left in r25 (remainder of tens division)
    add r25, r23              ; Convert to ASCII
;    rcall lcd_send_data        ; Send ones digit to LCD

    ret                        ; Return from subroutine

; Divide r26 by r28, result is quotient in r24 and remainder in r25
divide:
    clr r24                   ; Clear quotient register
    clr r25                   ; Clear remainder register
...
divide_done:
    mov r25, r26              ; Store remainder in r25
    ret                        ; Return with quotient in r24 and remainder in r25
